...
const toIntervalExpr = (expr, interval, base = 0, offset = 0) => {
...
// Take a time interval ISO 8601 string part and formats it correctly (ie, 2014-9-12T4 becomes 2014-09-12T04)
...
class UnimongoModel extends SchemaModel {
	...
	// Given a numeric interval, returns an expression that will result in the start value
	// of the interval in which the field lies.
	 ...
	 * @param {commonQuery.Aggregate} spec
	 * @return {Object}
	 */
	 ...
	 * @param {commonQuery.Query} query
	 * @param {Array{Object}|Array{commonQuery.Aggregate}} aggregates
	 * @param {Object} [options={}] - Mongo options
	 * @return {Object}
	 */
